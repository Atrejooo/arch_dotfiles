...
local DEFAULT_CONFIG = {
	...
	colors = require("colors.dracula.palette"),
	overrides = {},
	theme = "dracula",
}
...
local function apply(configs)
	...
	local groups = require("colors.dracula.groups").setup(configs)
...
local function get_configs()
	...
	if g.colors_name == "dracula-soft" then
		...
		configs.colors = require("colors.dracula.palette-soft")
	elseif g.colors_name == "dracula" then
		configs.theme = "dracula"
		configs.colors = require("colors.dracula.palette")
	end
